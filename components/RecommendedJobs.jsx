    ...
    return (
        <>
            <div className='mt-12 flex justify-between items-center'>
                ...
                <div className={`flex items-center border ${isDark && 'border-[#696974]'} gap-2 px-3 py-2 text-[#696974] rounded-lg whitespace-nowrap`}>See All <MdOutlineKeyboardArrowDown className='text-xl' /></div>
            </div>
