...
const FeaturedCompanyCard = ({ number }) => {
    ...
    return (
        <div className={`mt-10 ${isDark ? 'bg-[#1C1C24]' : 'bg-white'} px-4 py-6 rounded-lg md:max-w-[256px] flex flex-col justify-between`}>
            <div>
                <Link href='/companydetails'>
                    <div className='flex gap-6 items-center'>
                        <img src={apiData[number].employer_logo || 'https://static.vecteezy.com/system/resources/previews/005/337/799/original/icon-image-not-found-free-vector.jpg'} alt='company' className='w-12 h-12 object-contain' />
                        <div>
